...
public class Home extends AppCompatActivity {
    //mendeklarasikan objek yang akan dibuat
    ViewPager vp;
    TabLayout tl;
    AppBarLayout ab;
    Toolbar tbr;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //mengambil id dari objek yang sudah dideklarasikan
...
//        setSupportActionBar(tbr);
    ...
    public void postFoto(View view) {startActivity(new Intent(Home.this, Upload.class));}
